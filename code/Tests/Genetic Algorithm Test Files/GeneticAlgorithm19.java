...
class Algo19GA extends BaseAlgo19GA {
...
class Algo19Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo19GA algo = new Algo19GA(values);
		int myFitness = 0;
...
class Chromosome {	
	...
	// find fittest individual among 5 random individuals in the population and return that individual
	public static Individual naturalSelection(Population population) {
		
		// Select the fittest individual from a randomly chosen 5 individuals	
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo19GA algo = new Algo19GA(indiv.getGenotype());
