...
class Algo11GA extends BaseAlgo11GA {
...
class Algo11Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo11GA algo = new Algo11GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo11GA algo = new Algo11GA(indiv.getGenotype());
