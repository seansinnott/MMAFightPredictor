...
class Algo4GA extends BaseAlgo4GA {
...
class Algo4Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo4GA algo = new Algo4GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo4GA algo = new Algo4GA(indiv.getGenotype());
