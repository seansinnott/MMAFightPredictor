...
class Algo17GA extends BaseAlgo17GA {
...
class Algo17Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo17GA algo = new Algo17GA(values);
		int myFitness = 0;
...
class Individual {
	private int lengthOfChromosome = 11;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo17GA algo = new Algo17GA(indiv.getGenotype());
...
class GeneticAlgorithm17 {
	public static void main (String [] args) {
		...
		while (!convergence) {
			...
			System.out.print("[" + population.getFittestInPopulation().getGene(0) + "," + population.getFittestInPopulation().getGene(1) + "," + population.getFittestInPopulation().getGene(2) + "," + population.getFittestInPopulation().getGene(3) + "," + population.getFittestInPopulation().getGene(4) + "," + population.getFittestInPopulation().getGene(5) + "," + population.getFittestInPopulation().getGene(6) + "," + population.getFittestInPopulation().getGene(7) + "," + population.getFittestInPopulation().getGene(8) + "," + population.getFittestInPopulation().getGene(9) + "," + population.getFittestInPopulation().getGene(10) + "]");
