...
class Algo18GA extends BaseAlgo18GA {
...
class Algo18Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo18GA algo = new Algo18GA(values);
		int myFitness = 0;
...
class Individual {
	private int lengthOfChromosome = 12;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo18GA algo = new Algo18GA(indiv.getGenotype());
...
class GeneticAlgorithm18 {
	public static void main (String [] args) {
		...
		while (!convergence) {
			...
			System.out.print("[" + population.getFittestInPopulation().getGene(0) + "," + population.getFittestInPopulation().getGene(1) + "," + population.getFittestInPopulation().getGene(2) + "," + population.getFittestInPopulation().getGene(3) + "," + population.getFittestInPopulation().getGene(4) + "," + population.getFittestInPopulation().getGene(5) + "," + population.getFittestInPopulation().getGene(6) + "," + population.getFittestInPopulation().getGene(7) + "," + population.getFittestInPopulation().getGene(8) + "," + population.getFittestInPopulation().getGene(9) + "," + population.getFittestInPopulation().getGene(10) + "," + population.getFittestInPopulation().getGene(11) + "]");
