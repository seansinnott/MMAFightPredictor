...
class Algo9GA extends BaseAlgo9GA {
...
class Algo9Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo9GA algo = new Algo9GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo9GA algo = new Algo9GA(indiv.getGenotype());
