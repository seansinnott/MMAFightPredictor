...
class Algo13GA extends BaseAlgo13GA {
...
class Algo13Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo13GA algo = new Algo13GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo13GA algo = new Algo13GA(indiv.getGenotype());
