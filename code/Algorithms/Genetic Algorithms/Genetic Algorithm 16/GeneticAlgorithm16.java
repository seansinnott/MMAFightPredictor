...
class Algo16GA extends BaseAlgo16GA {
...
class Algo16Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo16GA algo = new Algo16GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo16GA algo = new Algo16GA(indiv.getGenotype());
