...
class Algo10GA extends BaseAlgo10GA {
...
class Algo10Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo10GA algo = new Algo10GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo10GA algo = new Algo10GA(indiv.getGenotype());
