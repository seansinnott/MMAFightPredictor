...
class Algo6GA extends BaseAlgo6GA {
...
class Algo6Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo6GA algo = new Algo6GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo6GA algo = new Algo6GA(indiv.getGenotype());
