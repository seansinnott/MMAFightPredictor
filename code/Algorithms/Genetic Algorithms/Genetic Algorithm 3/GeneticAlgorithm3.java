...
class Algo3GA extends BaseAlgo3GA {
...
class Algo3Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo3GA algo = new Algo3GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo3GA algo = new Algo3GA(indiv.getGenotype());
