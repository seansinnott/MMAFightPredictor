...
class Algo14GA extends BaseAlgo14GA {
...
class Algo14Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo14GA algo = new Algo14GA(values);
		int myFitness = 0;
...
class Individual {
	private int lengthOfChromosome = 5;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo14GA algo = new Algo14GA(indiv.getGenotype());
...
class GeneticAlgorithm14 {
	public static void main (String [] args) {
		...
		while (!maximumFitnessFound && !convergence) {
			...
			System.out.print("[" + population.getFittestInPopulation().getGene(0) + "," + population.getFittestInPopulation().getGene(1) + "," + population.getFittestInPopulation().getGene(2) + "," + population.getFittestInPopulation().getGene(3) + "," + population.getFittestInPopulation().getGene(4) + "]");
