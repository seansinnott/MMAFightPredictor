...
class Algo15GA extends BaseAlgo15GA {
...
class Algo15Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo15GA algo = new Algo15GA(values);
		int myFitness = 0;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo15GA algo = new Algo15GA(indiv.getGenotype());
