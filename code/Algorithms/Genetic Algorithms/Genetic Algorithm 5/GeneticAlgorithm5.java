...
class Algo5GA extends BaseAlgo5GA {
...
class Algo5Test {
	public int testOnUnseenFights(int [] values) {
		...
		Algo5GA algo = new Algo5GA(values);
		int myFitness = 0;
...
class Individual {
	private int lengthOfChromosome = 6;
...
class CalculateFitness {
	...
	public static int getFitness(Individual indiv) {		
		Algo5GA algo = new Algo5GA(indiv.getGenotype());
...
class GeneticAlgorithm5 {
	public static void main (String [] args) {
		...
		while (!maximumFitnessFound && !convergence) {
			...
			System.out.print("[" + population.getFittestInPopulation().getGene(0) + ", " + population.getFittestInPopulation().getGene(1) + ", " + population.getFittestInPopulation().getGene(2) + ", " + population.getFittestInPopulation().getGene(3) + ", " + population.getFittestInPopulation().getGene(4) + ", " + population.getFittestInPopulation().getGene(5) + "]");
